...
public class MyOkHttpClient {
    ...
    private static String APP_KEY = OauthConfig.getClientId();
    private static String REDIRECT_URI = "http://localhost:8000/oauth";
    ...
    public static boolean sendTalk(String token){
        try{
            ...
            String strBody = "template_object={\n" +
                    ...
                    "                            \"content\" : {\n" +
                    "                        \"title\":\"지원 템플릿\",\n" +
                    "                                \"image_url\":\"https://t1.daumcdn.net/daumtop_chanel/op/20200723055344399.png\",\n" +
                    "                                \"link\" : { \"web_url\" : \"www.naver.com\" },\n" +
                    "                        \"description\" : \"안녕하세요 [SouP]보고 연락 드렸습니다. [spring],[node]를 이용한 토이 프로젝트에 관심이 있고 저는[React]를 다룰 줄 압니다.  자세한 내용은 [이메일]로 연락주세요\"\n" +
                    "                    },\n" +
                    "                    \"item_content\" : {\n" +
