    ...
    public void getOkkyPostData() {
        ...
        try{
            ...
            while(Page>=1){
                ...
                Elements elements = doc.select("#__next > main > div > div:nth-child(2) > div:nth-child(3) > ul > li[class~='px-2']");
                for (int i = elements.size() - 1; i >= 0; i--) {
                    ...
                    String content = realPost.select("#__next > main > div > div:nth-child(2) > div > div:nth-child(2) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div > div > div").text();
