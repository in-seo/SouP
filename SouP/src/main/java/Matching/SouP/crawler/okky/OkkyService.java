    ...
    public void getOkkyPostData() {
        ...
        try{
            ...
            while(Page>=1){
                ...
                Elements elements = doc.select("#__next > main > div > div:nth-child(2) > div:nth-child(3) > ul > li:nth-child(4)");
                for (int i = elements.size() - 1; i >= 0; i--) {
                    Element element = elements.get(i);
                    Elements title = element.select("div > div:nth-child(2) > div > a.my-2");
                    ...
                    String content = realPost.select("#__next > main > div > div:nth-child(2) > div > div:nth-child(2) > div:nth-child(1) > div:nth-child(2) > div:nth-child(3) > div > div > div").text();
    ...
    private int startPage(WebDriver driver, int start) throws StringIndexOutOfBoundsException {
        ...
        while(true){
            ...
            try {
                ...
                cnt++;
                log.info("[StringIndexOutOfBoundsException] : " + href);
                SlackNotifier slackNotifier = new SlackNotifier();
